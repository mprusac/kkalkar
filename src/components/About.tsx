                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {achievement.emoji === "flags" ? (
                        <span className="flex items-center gap-1">
                          <img decoding="async" src={bihFlag} alt="BiH" className="h-[18px] w-[18px] object-contain rounded-full" />
                          <img decoding="async" src={croFlag} alt="Hrvatska" className="w-5 h-5 object-contain" />
                        </span>
                      ) : (
