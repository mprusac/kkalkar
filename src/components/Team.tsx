...
const players: Player[] = [
  ...
  },
  {
    ...
    number: "4",
    image: playerAlkar2,
    description: "Eksplozivni američki bek s izraženim šuterskim instinktom i sposobnošću da promijeni tijek utakmice.",
  ...
  },
  {
    ...
    number: "8",
    image: playerAlkar5,
    description: "Svestrani krilni igrač i vođa u svlačionici, iskusni Sinjanin s dugom karijerom u hrvatskoj košarci.",
