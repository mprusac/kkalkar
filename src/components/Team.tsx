                ...
                <div className="relative h-[280px] md:h-64 overflow-hidden">
                  {player.image ? (
                    <img
                      src={player.image}
                      alt={player.name}
                      className={`w-full h-full object-cover object-top transition-transform duration-500 ${player.id === 3 ? 'scale-[1.35] group-hover:scale-[1.42]' : 'scale-[1.03] group-hover:scale-110'}`}
                    />
                  ) : (
